<div id="content-page" class="content group">
    <div style="width: 80%" class="hentry group">
        {!! Form::open(['url' => (isset($user->id)) ? route('admin.users.update',
                ['users'=>$user->id]) : route('admin.users.store'),
        ...
        <ul>
            ...
            <li class="text-field">
                ...
                <div class="input-prepend"><span class="add-on">
				<i class="icon-user"></i></span>
                    {!! Form::text('login', isset($user->login) ? $user->login  :
                     old('login'), ['placeholder'=>'Введите логин']) !!}
                </div>
            </li>
            ...
            <li class="text-field">
				...
				<i class="icon-user"></i></span>
                    {!! Form::text('email',isset($user->email) ? $user->email  :
                      old('email'), ['placeholder'=>'Введите почту']) !!}
                </div>
            </li>
            ...
            <li class="text-field">
                ...
                <div class="input-prepend">
                    {!! Form::select('role_id', $roles, (isset($user)) ?
