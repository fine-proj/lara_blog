            ...
            <div class="section portfolio">
                ...
                @foreach($portfolios as $k=>$item)
                    ...
                    @endif
                                ...
                                <div class="{{ ($k == count($portfolios)-1) ? 'related_project related_project_last' : 'related_project'}}">
                                    <div class="overlay_a related_img">
                                        <div class="overlay_wrapper">
                                            <img src="{{ asset(env('THEME')) }}/images/projects/{{ $item->img->mini }}" alt="009" title="009" />
                                            <div class="overlay">
